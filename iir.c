 ...
 *
 * A port of my glame lowpass/highpass/bandpass filters due to public demand
 * in #lad. Try out the original at glame.sourceforge.net ;-)
 */
...
void calc_2polebandpass(iirf_t *iirf, iir_stage_t *gt, float fc, float bw,
    ...
    /* if I go all the way up to 0.5 it doesn't work */
    fc = CLAMP(fc, 0.0, (float)sample_rate * 0.45f);
